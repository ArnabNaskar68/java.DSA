...
//         }
//     }
//     public static  ArrayList<ArrayList<Integer>> checkForZeroes(ArrayList<ArrayList<Integer>> matrix, int n, int m){
//         //check for 0
//         for(int i=0; i<n; i++){
//             for(int j=0; j<m; j++){
//                 if(matrix.get(i).get(j)==0){
...
//          ArrayList<ArrayList<Integer>> ans=checkForZeroes(matrix, n, m);
